...
import static net.sourceforge.align.calculator.length.PoissonDistributionCalculator.factorial;
import static net.sourceforge.align.calculator.length.PoissonDistributionCalculator.poissonDistribution;
