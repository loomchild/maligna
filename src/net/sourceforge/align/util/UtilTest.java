...
public class UtilTest {
	...
	public void alignManyToZero() {
		...
		Util.assertAlignmentEquals(new String[]{"a", "b"},	new String[]{},
				alignment);
	}
	...
	public void alignZeroToMany() {
		...
		assertEquals(1, alignmentList.size());
		Alignment alignment = alignmentList.get(0);
		Util.assertAlignmentEquals(new String[]{},	new String[]{"a", "b"},
				alignment);
	}
	...
	public void alignManyToMany() {
		...
		assertEquals(1, alignmentList.size());
		Alignment alignment = alignmentList.get(0);
		Util.assertAlignmentEquals(new String[]{"a","b"},
	...
	public void assertAlignmentEquals() {
		...
		Util.assertAlignmentEquals(new String[]{"a", "b"},	new String[]{"c"},
				alignment);
		try {
			Util.assertAlignmentEquals(new String[]{"a", "b"},	new String[]{"d"},
					alignment);
