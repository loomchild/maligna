...
public class ComparatorTest {
	...
	public void testSimple() {
		...
		assertEquals(rightAlignmentList.get(0), diff.getCommonList().get(0));
		assertEquals(rightAlignmentList.get(2), diff.getCommonList().get(1));
	...
	public void testRepetitions() {
		...
		assertEquals(rightAlignmentList.get(0), diff.getCommonList().get(0));
		assertEquals(rightAlignmentList.get(1), diff.getCommonList().get(1));
		assertEquals(rightAlignmentList.get(3), diff.getCommonList().get(2));
	...
	public void testInversions() {
		...
		assertEquals(2, diff.getCommonList().size());
		assertEquals(rightAlignmentList.get(1), diff.getCommonList().get(0));
		assertEquals(rightAlignmentList.get(2), diff.getCommonList().get(1));
