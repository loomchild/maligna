...
import static net.loomchild.maligna.model.vocabulary.VocabularyUtil.DEFAULT_MAX_WORD_COUNT;
import static net.loomchild.maligna.model.vocabulary.VocabularyUtil.DEFAULT_MIN_OCCURRENCE_COUNT;
import static net.loomchild.maligna.model.vocabulary.VocabularyUtil.DEFAULT_TOKENIZE_ALGORITHM;
...
import net.loomchild.maligna.filter.modifier.modify.split.SrxSplitAlgorithm;
import net.loomchild.maligna.model.vocabulary.Vocabulary;
import net.loomchild.maligna.util.Pair;
...
import net.loomchild.maligna.filter.modifier.modify.NullModifyAlgorithm;
import net.loomchild.maligna.filter.modifier.modify.clean.FilterNonWordsCleanAlgorithm;
import net.loomchild.maligna.filter.modifier.modify.clean.LowercaseCleanAlgorithm;
import net.loomchild.maligna.filter.modifier.modify.clean.TrimCleanAlgorithm;
...
import net.loomchild.maligna.filter.modifier.modify.split.ParagraphSplitAlgorithm;
import net.loomchild.maligna.filter.modifier.modify.split.SentenceSplitAlgorithm;
