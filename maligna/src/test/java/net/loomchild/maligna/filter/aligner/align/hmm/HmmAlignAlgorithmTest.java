...
public abstract class HmmAlignAlgorithmTest {
	...
	public void testOneToZero() {
		...
		TestUtil.assertAlignmentEquals(sourceSegments, targetSegments, result.get(0));
	}
	...
	public void testPreservesAllSegments() {
		...
		TestUtil.assertAlignmentListContains(sourceSegments, targetSegments, result);
	}
	...
	public void testVeryShortAndLongInterleaved() {
		...
		TestUtil.assertAlignmentListEquals(expectedSourceSegments, 
